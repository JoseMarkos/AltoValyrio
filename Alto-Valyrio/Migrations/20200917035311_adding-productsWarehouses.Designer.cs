...
namespace Alto_Valyrio.Migrations
{
    ...
    [Migration("20200917035311_adding-productsWarehouses")]
    partial class addingproductsWarehouses
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Alto_Valyrio.src.Inventory.Products.Domain.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Alto_Valyrio.src.Inventory.Products.Domain.Packing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Alto_Valyrio.src.Inventory.ProductsWarehouses.Domain.ProductsWarehouse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Alto_Valyrio.src.Inventory.Products.Domain.Product", b =>
                {
                    b.HasOne("Alto_Valyrio.src.Inventory.Products.Domain.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Alto_Valyrio.src.Inventory.ProductsWarehouses.Domain.ProductsWarehouse", b =>
                {
                    b.HasOne("Alto_Valyrio.src.Inventory.Products.Domain.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Alto_Valyrio.src.Inventory.Warehouses.Domain.Warehouse", "Warehouse")
                        .WithMany()
